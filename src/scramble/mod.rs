...
mod test {
    ...
    #[test]
    fn test_scramble() {
        let scr = [0x4e_u8, 0x52_u8, 0x33_u8, 0x48_u8, 0x50_u8, 0x3a_u8, 0x71_u8, 0x49_u8,
                   0x59_u8, 0x61_u8, 0x5f_u8, 0x39_u8, 0x3d_u8, 0x64_u8, 0x62_u8, 0x3f_u8,
                   0x53_u8, 0x64_u8, 0x7b_u8, 0x60_u8];

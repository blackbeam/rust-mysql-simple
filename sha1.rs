...
mod test {
    ...
    #[test]
    fn test_sha1() {
        assert!(sha1([115u8, 104u8, 97u8]) == [0xd8u8, 0xf4u8, 0x59u8, 0x03u8, 0x20u8, 0xe1u8, 0x34u8, 0x3au8, 0x91u8, 0x5bu8, 0x63u8, 0x94u8, 0x17u8, 0x06u8, 0x50u8, 0xa8u8,  0xf3u8, 0x5du8, 0x69u8, 0x26u8]);
        assert!(sha1([65u8, ..57]) == [0xe8u8, 0xd6u8, 0xeau8, 0x5cu8, 0x62u8, 0x7fu8, 0xc8u8, 0x67u8, 0x6fu8, 0xa6u8, 0x62u8, 0x67u8, 0x7bu8, 0x02u8, 0x86u8, 0x40u8, 0x84u8, 0x4du8, 0xc3u8, 0x5cu8]);
        assert!(sha1([65u8, ..56]) == [0x6bu8, 0x45u8, 0xe3u8, 0xcfu8, 0x1eu8, 0xb3u8, 0x32u8, 0x4bu8, 0x9fu8, 0xd4u8, 0xdfu8, 0x3bu8, 0x83u8, 0xd8u8, 0x9cu8, 0x4cu8, 0x2cu8, 0x4cu8, 0xa8u8, 0x96u8]);
        assert!(sha1([65u8, ..64]) == [0x30u8, 0xb8u8, 0x6eu8, 0x44u8, 0xe6u8, 0x00u8, 0x14u8, 0x03u8, 0x82u8, 0x7au8, 0x62u8, 0xc5u8, 0x8bu8, 0x08u8, 0x89u8, 0x3eu8, 0x77u8, 0xcfu8, 0x12u8, 0x1fu8]);
        assert!(sha1([65u8, ..65]) == [0x82u8, 0x6bu8, 0x7eu8, 0x7au8, 0x7au8, 0xf8u8, 0xa5u8, 0x29u8, 0xaeu8, 0x1cu8, 0x74u8, 0x43u8, 0xc2u8, 0x3bu8, 0xf1u8, 0x85u8, 0xc0u8, 0xadu8, 0x44u8, 0x0cu8]);
    }
}